...
class Module internal constructor(val name: String? = null) {
    ...
    inline fun <reified T> bind(name: String? = null,
...
class BindingDsl<T>(private val module: Module,
     ...
     */
    fun factory(body: ProviderDsl.() -> T): Module =
     ...
     */
    fun singleton(body: ProviderDsl.() -> T): Module =
     ...
     */
    fun eagerSingleton(body: ProviderDsl.() -> T): Module =
...
class ProviderDsl(val context: ComponentContext) {
     ...
     */
    inline fun <reified T> get(name: String? = null) =
     ...
     */
    inline fun <reified T> lazy(name: String? = null) =
        lazy { get<T>(name) }
}
